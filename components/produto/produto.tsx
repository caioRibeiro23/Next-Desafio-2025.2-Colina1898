...
export default function Produto({ temDesc }: {temDesc: boolean}){
    return (
        ...
        ${temDesc ? "bg-[url('/produtos/fundoProduto.png')] bg-cover bg-center bg-black/80 bg-blend-darken w-55 sm:w-70 bp-540:w-80 md:w-70 bp-840:w-75 lg:w-80 xl:w-85 3xl:w-90 hover:scale-105" : "bg-pretoSuave"}`}>
