...
export default function Produto({ temDesc }: {temDesc: boolean}){
    return (
        <div className="flex flex-col items-center justify-center p-2.5 bg-pretoSuave rounded-2xl border border-dourado border-2 gap-2.5 w-45 sm:w-55 bp-540:w-70 md:w-55 bp-840:w-65 lg:w-80 xl:w-85 3xl:w-90 hover:scale-105 transition-all duration-200 cursor-pointer">
