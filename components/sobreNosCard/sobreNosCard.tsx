...
export default function SobreNos({ titulo, texto }: { titulo: string; texto: string }) {
    return (
        <div className="bg-[url('/fundo/fundoCardSobre.jpg')] bg-cover bg-center bg-black/90 bg-blend-darken flex flex-col items-center justify-start p-2.5 rounded-2xl border-dourado border-2 gap-2.5 w-50 sm:w-65 bp-540:w-70 md:w-55 bp-840:w-65 lg:w-75 xl:w-85 3xl:w-90 ">
