    ...
    <div className="w-full flex md:h-screen relative ">
        ...
        {/* topo - pré tabela */}
          ...
          <div className="flex flex-col w-full gap-2.5 p-2.5">
            {/* tabela - cabeçalho */}
              <div className=" grid grid-cols-[1fr_2.5fr_2fr_1.5fr] bp-840:grid-cols-[1fr_1fr_2.5fr_1fr_2fr] items-center justify-center py-2.5 w-full border border-dourado rounded-4xl bg-black/70">
